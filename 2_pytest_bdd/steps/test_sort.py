from func import my_sort1, my_sort2
import pytest
from pytest_bdd import scenario, given, when, then

@scenario('/home/dasha/Desktop/BIKT/BIKT/2_pytest_bdd/features/f.feature','Data need to be sorted by abs with function sorted')
def testing_my_sort1():
    pass

@scenario('/home/dasha/Desktop/BIKT/BIKT/2_pytest_bdd/features/f2.feature','Data need to be sorted by abs with lambda expression')
