...
def test_task3(man, det, men_dets):
    assert task3(man, det, men_dets) == [('Авток', 'Втулка', 70), ('Авток', 'Шпонка', 110), ('Арстат', 'Втулка', 70), ('Арстат', 'Шпонка2', 40), ('Гидросталь', 'штуцер', 100), ('Гидросталь', 'Шпонка', 110), ('Россталь', 'Винт', 50), ('Россталь', 'Пружина', 45), ('Эргон', 'Втулка', 70), ('Эргон', 'Пружина', 45)]
